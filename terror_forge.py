# -*- coding: utf-8 -*-
"""Copy of Terror-Forge.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HejJKPu0PCqE-E66HfjANalyERXXK5Uo
"""
...
def chunk_and_export(wav_path: str, speaker_label: str = "unknown", user_tag: str = ""):
    ...
    try:
        ...
        # 🏷️ Prepend user-defined tag if provided
...
# 🎯 MANUAL INPUTS (edit these before running the block)
MIDDLE_SEGMENT_DURATION = 500  # 🔧 Duration in seconds to diarize (e.g. 300 = 5 min)
CUSTOM_LABEL = "Test"  # 🏷️ Add a custom name tag to appear in output filenames

# 🎯 URL(s) to process
YOUTUBE_URLS = [
    "https://www.youtube.com/",
    "https://www.youtube.com/"  # 👈 Add or replace links here
]
...
for url_index, url in enumerate(YOUTUBE_URLS):
    ...
    # ✂️ Extract the middle segment (user-defined) before any preprocessing
    logger.info("✂️ Extracting middle segment of audio for processing and diarization")
    audio = AudioSegment.from_wav(wav_path)
    ...
    try:
        ...
        for segment, speaker in fused_segments:
            ...
            # 🛡️ Defensive check to avoid slicing beyond audio length
            if end_ms > len(middle_audio):
                logger.warning(f"⚠️ Segment end {end_ms}ms exceeds audio length {len(middle_audio)}ms — skipping.")
                continue
...
# For pushing this whole thing to GitHub

!git config --global user.email "clinton.brennan.may@gmail.com"
!git config --global user.name "ClintonAImadscience"



!git clone https://github.com/ClintonAImadscience/terror-forge.git

!cp "/content/drive/MyDrive/Colab Notebooks/terror_forge.py" /content/terror-forge/terror_forge.py